...
export class SubjectVideosService {
  ...
  public myParams = new HttpParams();

  createSubject(formData: FormData, queryDataTitle: string, id: number): Observable<Subject> {
    
    const params = this.myParams.set('title', queryDataTitle).set('id', id.toString())
